...
"}")
        ...
        icon = QtGui.QIcon.fromTheme("f:\\__MY_PROJECT__\\Python\\ResistorCalculator\\images\\new.png")
        self.actionNew.setIcon(icon)
        self.actionNew.setObjectName("actionNew")
        self.actionSave = QtWidgets.QAction(ResistorCalculator)
        icon = QtGui.QIcon.fromTheme("f:\\__MY_PROJECT__\\Python\\ResistorCalculator\\images\\save.png")
        self.actionSave.setIcon(icon)
        self.actionSave.setObjectName("actionSave")
        self.actionOpen = QtWidgets.QAction(ResistorCalculator)
        icon = QtGui.QIcon.fromTheme("f:\\__MY_PROJECT__\\Python\\ResistorCalculator\\images\\open.png")
        self.actionOpen.setIcon(icon)
        self.actionOpen.setObjectName("actionOpen")
        self.actionExit = QtWidgets.QAction(ResistorCalculator)
        icon = QtGui.QIcon.fromTheme("f:\\__MY_PROJECT__\\Python\\ResistorCalculator\\images\\exit.png")
        self.actionExit.setIcon(icon)
        self.actionExit.setObjectName("actionExit")
        self.actionInfo = QtWidgets.QAction(ResistorCalculator)
        icon = QtGui.QIcon.fromTheme("f:\\__MY_PROJECT__\\Python\\ResistorCalculator\\images\\info.png")
