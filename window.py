...
class Ui_ResistorCalculator(object):
    def setupUi(self, ResistorCalculator):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(-1, 110, 801, 51))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(70, 52, 191, 16))
        font = QtGui.QFont()
        font.setFamily("Rubik")
        font.setKerning(True)
        ...
        self.ResistFormula.setGeometry(QtCore.QRect(70, 20, 641, 30))
        font = QtGui.QFont()
        font.setFamily("Rubik")
        ...
        self.radioButtonResistor = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonResistor.setGeometry(QtCore.QRect(720, 7, 71, 17))
        self.radioButtonResistor.setChecked(True)
        self.radioButtonResistor.setObjectName("radioButtonResistor")
        self.radioButtonCapacity = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonCapacity.setGeometry(QtCore.QRect(720, 27, 71, 17))
        self.radioButtonCapacity.setChecked(False)
        self.radioButtonCapacity.setObjectName("radioButtonCapacity")
        self.radioButtonRC = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButtonRC.setGeometry(QtCore.QRect(720, 47, 71, 17))
